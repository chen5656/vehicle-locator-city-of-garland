                ...
                array.forEach(fieldMeta.actions, lang.hitch(this, function (item) {
                    if (item === 'up') {
                        var moveupDiv = html.create('div', {
                            'class': 'action-item jimu-float-leading  esri-icon esri-icon-up-arrow'
                        }, actionItemParent);
                        ...
                        var movedownDiv = html.create('div', {
                            'class': 'action-item jimu-float-leading  esri-icon  esri-icon-down-arrow'
                        }, actionItemParent);
                        ...
                        var loadDiv = html.create('div', {
                            'class': 'action-item  jimu-float-leading  esri-icon esri-icon-plus-circled'
                        }, actionItemParent);
                        ...
                        var loadDiv = html.create('div', {
                            'class': 'action-item  jimu-float-leading esri-icon esri-icon-download'
                        }, actionItemParent);
                        ...
                        var editDiv = html.create('div', {
                            'class': 'action-item  jimu-float-leading  esri-icon esri-icon-edit'
                        }, actionItemParent);
                        editDiv.title = "Rename";
                        ...
                        var deleteDiv = html.create('div', {
                            'class': 'action-item  jimu-float-leading esri-icon  esri-icon-close'
                        }, actionItemParent);
