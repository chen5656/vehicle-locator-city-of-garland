...
--	addr_name	varchar2(80) :=	'901 -902  w avenue e '	;	
	...
	addr_name	varchar2(80) :=	'rowlett'	;	
	addr_num	varchar2(20) :=	'1118'	;	
	addr_type	varchar2(10) :=	'rd'	;	
	addr_pfx	varchar2(10) :=	''	;		
	addr_sfx	varchar2(10) :=	''	;	

	addr_code1	varchar2(10) :=	''	;	
	addr_unit1	varchar2(20) :=	's/tank'	;	
...
--	===============================================	
	...
	from		gis_app_rowid		r,
			adrResult_Local		l
	where		r.row_seq	= do_seq
	and		l.rowid	= r.row_id;
...
--	LIMITS
	...
	name_min		number := 03;	--	min name length
