...
--		vowel dipthong		revise (was error)
--		step info			error - out 
...
--	===============================================================
	...
	weight_final		number	:= 10;		--	final e or s mismatch
...
--	decide whether to continue or revector 
	...
	if	series = 01	
	or  (	series = 02	and	have.stops >= had.stops )	
