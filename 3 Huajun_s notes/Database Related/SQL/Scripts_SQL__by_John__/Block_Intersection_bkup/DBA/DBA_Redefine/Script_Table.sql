...
,MAPID                         NUMBER   (10)
,NAME                          VARCHAR2 (40)
,HOUSING_RATING                VARCHAR2 (5)
,NUISANCE_RATING               VARCHAR2 (5)
)
tablespace GIS_DATA   pctfree 10  pctused 40
           initrans 1 maxtrans 255
storage   (initial 1M next 1M pctincrease 0
...
select 'CREATE INSP_ARCH_BKUP' " " from dual;
create table   GARLAND.INSP_ARCH_BKUP
(
 CATEGORY                      VARCHAR2 (1)
,BRANCH                        NUMBER   (4)
,SECTION                       NUMBER   (4)
...
select 'CREATE UTWATPIP_ATS1' " " from dual;
create table   GARLAND.UTWATPIP_ATS1
(
 MSLINK                        NUMBER   (10) not null
,MAPID                         NUMBER   (10)
,PIPE_DIAMETER                 FLOAT    (21)
,PIPE_LENGTH                   FLOAT    (21)
,PIPE_MATERIAL                 VARCHAR2 (5)
,UP_NODE_ID                    VARCHAR2 (12)
,DN_NODE_ID                    VARCHAR2 (12)
,UP_NODE_ELEV                  FLOAT    (21)
,UP_NODE_GRND_ELEV             FLOAT    (21)
,DN_NODE_ELEV                  FLOAT    (21)
,DN_NODE_GRND_ELEV             FLOAT    (21)
,SLOPE                         FLOAT    (21)
,PIPE_CLASS                    VARCHAR2 (5)
,PIPE_MANUFACTURER             VARCHAR2 (20)
,PIPE_USE                      VARCHAR2 (10)
,AS_BUILT_DATE                 NUMBER   (10)
...
,REPAIR_DATE                   NUMBER   (10)
,WORK_ORDER_NUM                VARCHAR2 (10)
,INSPECT_DATE                  NUMBER   (10)
...
select 'CREATE TRVEHRCL_COPY' " " from dual;
create table   GARLAND.TRVEHRCL_COPY
(
 MSLINK                        NUMBER   (10) not null
,MAPID                         NUMBER   (10)
,CLINE_ID                      NUMBER   (10)
...
tablespace GIS_DATA   pctfree 20  pctused 80
           initrans 1 maxtrans 255
storage   (initial 6M next 1M pctincrease 0
           minextents 1  maxextents 505
           freelists  1  freelist groups 1)
...
select 'CREATE CDRELPAR_COPY' " " from dual;
create table   GARLAND.CDRELPAR_COPY
(
 MSLINK                        NUMBER   (10) not null
,MAPID                         NUMBER   (10)
,PARCEL_ID                     VARCHAR2 (11) not null
...
tablespace GIS_DATA   pctfree 30  pctused 70
           initrans 1 maxtrans 255
storage   (initial 11M next 2M pctincrease 0
           minextents 1  maxextents 505
           freelists  1  freelist groups 1)
...
select 'CREATE PAVE_MAST_BKUP' " " from dual;
create table   GARLAND.PAVE_MAST_BKUP
(
 CATEGORY                      VARCHAR2 (1) not null
,BRANCH                        NUMBER   (4) not null
,SECTION                       NUMBER   (4) not null
...
tablespace GIS_DATA   pctfree 10  pctused 90
           initrans 1 maxtrans 255
storage   (initial 6M next 1M pctincrease 0
           minextents 1  maxextents 121
           freelists  1  freelist groups 1)
...
select 'CREATE CDRELADR_COPY' " " from dual;
create table   GARLAND.CDRELADR_COPY
(
 PARCEL_ID                     VARCHAR2 (20) not null
,ADDR_ID                       NUMBER   (10)
,ADDR_NUM                      NUMBER   (10)
