select 'GIS_TEMP3_X_KEY' " " from dual;
create index   GARLAND.GIS_TEMP3_X_KEY
...
select 'GIS_TEMP4_X_KEY' " " from dual;
create index   GARLAND.GIS_TEMP4_X_KEY
...
select 'GIS_TEMP2_X_KEY' " " from dual;
create index   GARLAND.GIS_TEMP2_X_KEY
...
select 'GIS_TEMP1_X_KEY' " " from dual;
create index   GARLAND.GIS_TEMP1_X_KEY
...
add constraint CDRELADR_ADDR_ID
unique
(
 addr_id
)
