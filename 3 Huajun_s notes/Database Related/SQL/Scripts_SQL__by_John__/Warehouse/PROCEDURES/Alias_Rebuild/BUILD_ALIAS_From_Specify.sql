...
--	execute	garland.BUILD_ALIAS_FROM_SPECIFY

--	create or replace procedure garland.BUILD_ALIAS_FROM_SPECIFY	AS
...
BEGIN
	...
	select 'ALIAS FROM SPECIFY   '||to_char(sysdate,'Mon dd hh24:mi') into heading from dual; 
