...
--	=====================================================================
	...
	is_not_inactive	varchar2(10) := '99999999';
	this_date		varchar2(10) := is_not_inactive;
...
BEGIN
	...
	select active time from garland.CCS_Identifier_New	where active   < is_not_inactive
	UNION ALL 
	select inactive time from garland.CCS_Identifier_New	where inactive < is_not_inactive);
