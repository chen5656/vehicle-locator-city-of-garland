...
--	======================================================================================================
	...
	execute	:strname :=	upper('WALNUT CIRCLE EAST');	--	S P E C I F Y
	execute	:strnum :=	706				--	S P E C I F Y 
...
--	======================================================================================================
	...
	select
		'EXT' EXT,
		rpad(nvl(gis_key,	   0), 06)		gis,
		rpad(nvl(tax_key,	   0), 06)		tax,
		rpad(nvl(ums_key,	   0), 06)		ums,
