...
begin
	...
	title := 'BUILD COMMON UMS  ';	dbms_output.put_line(title);
...
(
	...
	dbms_output.put_line ( 'Total Common UMS: ' || total_processed);

	COMMIT;

--	=================================================================================

	update garland.Common_UMS set addr_type = ' ' where addr_type is null;
	update garland.Common_UMS set addr_pfx  = ' ' where addr_pfx  is null;
	update garland.Common_UMS set addr_sfx  = ' ' where addr_sfx  is null;
