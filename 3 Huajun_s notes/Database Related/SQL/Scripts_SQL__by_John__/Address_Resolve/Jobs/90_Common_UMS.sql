...
--	=================================================================================================
--	Copy adrResult to adrResult_UMS_Location
...
--	=================================================================================================
	...
	comment on table GIS_VERIFY_ADDR IS	'adrResult_UMS_Location';

	select table_name, comments from all_tab_comments where table_name = 'GIS_VERIFY_ADDR';

	select table_name, comments from all_tab_comments where table_name = 'ADRRESULT_UMS_LOCATION';
