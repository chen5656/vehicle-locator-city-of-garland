...
--	======================================================================================================
	...
	select '*** load Good Number alter ***  ' " ", to_char(sysdate, 'mm-dd-yyyy hh24:mi:ss') " " from dual;
	spool	c:\deacutis\scripts\address_resolve\alterations\50_Good_Number.sql;		--	change
...
--	===============================================
	...
	where	trunc (verify_code, -1) = 50			--	change
	and	verify_code < 55
