...
--	======================================================================================================
	...
	select '*** load Like Name alter ***  ' " ", to_char(sysdate, 'mm-dd-yyyy hh24:mi:ss') " " from dual;
	spool	c:\deacutis\scripts\address_resolve\alterations\09_Like_Name.sql;			--	change


	select	distinct
			rpad(
			'insert into garland.Alter_vw	values ('	||
			rpad (digits, 08)			|| ''''	||
			id					||
--			'  #'					|| seq	||
			' ', 53)				" ",
...
--	===============================================
	...
	where	upper(do_alias)	like 'LIKE%'						--	change
