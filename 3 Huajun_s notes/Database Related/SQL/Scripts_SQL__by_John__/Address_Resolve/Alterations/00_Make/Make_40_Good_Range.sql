...
--	======================================================================================================
	...
	select '*** load Good Range alter ***  ' " ", to_char(sysdate, 'mm-dd-yyyy hh24:mi:ss') " " from dual;
	spool	c:\deacutis\scripts\address_resolve\alterations\40_Good_Range.sql;			--	change
...
--	===============================================
	...
	where	trunc (verify_code, -1) = 40			--	change
