...
--	===================================================================================================
	...
	spool	c:\deacutis\scripts\address_resolve\reports\Made_Report\S2_Change_Suffix.sql;

	select	distinct
			'change suffix'			"Street Change"
...
--			,lpad(v.verify_code,03)		"ver"	
	...
	where		v.do_qual like	'%cs%'
	or		v.do_qual like	'%rs__as%'
