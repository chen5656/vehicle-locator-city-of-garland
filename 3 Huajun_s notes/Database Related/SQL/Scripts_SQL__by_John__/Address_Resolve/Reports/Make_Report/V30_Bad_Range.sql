...
--	set termout	off;
	...
	spool	c:\deacutis\scripts\address_resolve\reports\Made_Report\V30_Bad_Range.sql;

	select	--+ rule
			distinct

			'bad number ' 			"bad range"
			,'   '				" "
