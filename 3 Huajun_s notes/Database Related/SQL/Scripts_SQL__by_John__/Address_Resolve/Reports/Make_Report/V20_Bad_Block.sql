...
--	set termout	off;
	...
	spool	c:\deacutis\scripts\address_resolve\reports\Made_Report\V20_Bad_Block.sql;

	select	--+ rule
			distinct

			'bad number ' 			"bad block"
