...
--	===================================================================================================
	...
	spool	c:\deacutis\scripts\address_resolve\reports\Made_Report\S3_Remove_Suffix.sql;

	select	distinct
			'remove suffix  '			"Street Change"
...
--			,lpad(v.verify_code,03)		"ver"	
	...
	where		v.do_qual like	 '%rs%'
	and		v.do_qual not like '%as%'
