	...
	drop table		garland.adrResult_Extract;
...
--	==================================================================================================
	...
	create index	garland.adrResult_Extract_seq
		on		garland.adrResult_Extract (rec_seq)
	nologging
	tablespace		gisindx
...
--	==================================================================================================
	...
	create index	garland.adrResult_Extract_key
		on		garland.adrResult_Extract (rec_key)
