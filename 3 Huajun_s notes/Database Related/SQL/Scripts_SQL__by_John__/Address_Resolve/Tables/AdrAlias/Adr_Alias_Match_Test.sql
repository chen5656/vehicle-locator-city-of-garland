...
declare 
	...
	start_seq		number	:= 0333;
	stop_seq		number	:= 0333;
	...
	alias_match		resolve_address.alias_match;
...
--	AD HOC
	...
	elsif	seq = 10	then						--	pull

		addr_num	:= 1234;
		addr_type	:= 'PKWY';
		right_class	:= 'pull';

	elsif	seq = 11	then						--	part/
	...
	elsif	seq = 12	then 						--	more1
		addr_num	:= 1234;
		addr_name	:= 'BRIDGE';
		right_class	:= 'more';

	elsif	seq = 13	then 						--	more2
		addr_num	:= 1234;
		addr_name	:= 'BRANDON';
		right_class	:= 'more';

	elsif	seq = 14	then 						--	pcut
		addr_num	:= 1234;
		addr_name	:= 'NSHILOH';
		right_class	:= 'pcut';

	elsif	seq = 15	then						--	LIKE
...
--	=========================================================================================================
--	reduced_name := adr_compress_name ( addr_name, '1');
...
--	=========================================================================================================
	...
	garland.ADR_FIND.FIND_ALIAS		--  live
--	garland.ADR_FIND_01.FIND_ALIAS	--  test
