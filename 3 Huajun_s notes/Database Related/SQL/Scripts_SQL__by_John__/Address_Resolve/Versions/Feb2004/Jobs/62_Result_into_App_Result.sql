...
--				****   C H A N G E   ****		
	...
	create table	garland.adrResult_ALPHA5
...
--	========================================================================================
	...
	select * from user_segments where segment_name	= 'ADRRESULT_ALPHA5';	-- CHANGE

	select * from user_tables   where table_name	= 'ADRRESULT_ALPHA5';	-- CHANGE
