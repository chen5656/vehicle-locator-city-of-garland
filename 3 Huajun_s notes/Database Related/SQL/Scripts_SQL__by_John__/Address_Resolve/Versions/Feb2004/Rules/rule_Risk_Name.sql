...
--	============================================================
--	"Risk Name Correction" address resolution rules
--	============================================================
...
--	functions
	...
	do_alias			number	:= alias_addr;
--	do_alias			number	:= alias_form;

	do_unparsed_exit		number	:= 0;
...
--	street qualifier correction 
	...
	remove_unq	number	:= 1;
		...
		str_sfx		number	:= change;

		blk_type		number	:= none;
		blk_pfx		number	:= none;
		blk_sfx		number	:= none;

		adr_type		number	:= none;
		adr_pfx		number	:= none;
		adr_sfx		number	:= none;

		rng_type		number	:= none;
		rng_pfx		number	:= none;
		rng_sfx		number	:= none;
...
--	street correction permission
	...
	permit		number	:= 9;
		...
		permit_blk_append		number	:= forbid;
		permit_blk_remove		number	:= forbid;
		permit_blk_change		number	:= forbid;

		permit_adr_basis		number	:= none;
		permit_adr_append		number	:= forbid;
		permit_adr_remove		number	:= forbid;
		permit_adr_change		number	:= forbid;

		permit_rng_basis		number	:= none;
		permit_rng_append		number	:= forbid;
		permit_rng_remove		number	:= forbid;
		permit_rng_change		number	:= forbid;
