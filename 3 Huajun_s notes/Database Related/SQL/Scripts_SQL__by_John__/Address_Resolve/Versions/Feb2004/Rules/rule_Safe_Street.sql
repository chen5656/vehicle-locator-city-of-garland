...
--	============================================================
--	"Safe Street" address resolution rules
--	============================================================
...
--	functions
	...
	do_parse			number	:= 00000;

		alias_form		number	:= 1;
		alias_fuzzy		number	:= 2;
		alias_addr		number	:= 3;
	do_alias			number	:= 00000;
...
--	street qualifier correction weights
	...
	remove_unq	number	:= 1;
		...
		str_unq_type	number	:= append_unq;
		str_unq_pfx		number	:= append_unq;
...
--		rng_sfx		number	:= blank;
		...
		rng_type		number	:= match;		-- oct 2004
		rng_pfx		number	:= match;
		rng_sfx		number	:= match;
