...
declare
	...
	do_trace_region	binary_integer	:= 0;
...
--	-----------------------------------------------------------------------------------------------------
	...
	and	adr.status like '%S%'
	and	adr.status like '%4%'			then
		dbms_output.put_line ( '.......................................................');
	...
	if	do_trace >= do_trace_basic		then
	dbms_output.put_line (' ');
	dbms_output.put_line ('  ' || occurs   ||' '|| control   ||' options - First one is at '|| choice );
