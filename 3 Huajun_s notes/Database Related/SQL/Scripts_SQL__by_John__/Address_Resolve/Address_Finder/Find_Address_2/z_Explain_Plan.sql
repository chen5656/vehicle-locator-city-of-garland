...
--	==========================================================
	...
	select	--+ first_rows
		...
		sign(a.addr_num	+ 01) + :01,	--	rule = null or 0
		sign(b.addr_block + 01) + :02,	--	rule = null or 0
		n.name_class		+ :03-,	--	rule = null or 0
