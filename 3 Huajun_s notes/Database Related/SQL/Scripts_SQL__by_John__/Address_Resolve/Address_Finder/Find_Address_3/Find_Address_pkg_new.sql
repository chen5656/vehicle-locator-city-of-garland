...
/*	Address should be fixed string of Address Option info
	...
	Type	Address_Option	is record		-- total = 80
(			
	...
	status		varchar2(10),
	location_id		varchar2(20)		-- address, block, street

--	region array can hold additional location ids, if requested
);
...
--	========================================================================
	...
	Intersection		varchar2(80);	-- 2 intersections (40 + 40)
	...
	Type Region_Array		is table of		General_ID%type
		index by binary_integer;
