...
--	===================================================================================================
	...
	spool	c:\deacutis\scripts\address_resolve\reports\Made_Report\S3_Remove_Prefix.sql;

	select	distinct
			'remove prefix  '			"Street Change"
...
--			,lpad(v.verify_code,03)		"ver"	
	...
	where		v.do_qual like	 '%rp%'
	and		v.do_qual not like '%ap%'
