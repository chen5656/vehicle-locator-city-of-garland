...
--	drop table		garland.EASEMENT_UTILITY;			--	change

	Create table	garland.EASEMENT_UTILITY			--	change
(
...
--	========================================================================
	...
	alter table		garland.easement_UTILITY			--	change
	add
(
	constraint	easement_UTILITY_mslink					--	change
	unique	(mslink)
