...
(
	...
	from		dba_ind_columns@gisp	i,
			dba_tab_columns@gisp	c,
			plan_table			p
...
--	====================================================================
	...
	select
		rpad(d.referenced_name,25) "Object", rpad(referenced_type,15) "Obj Type", 
		d.name "Dependent", d.type "Dep Type"
	from	dba_dependencies@gisp	d, 	
		plan_table			p
	...
	select
		rpad(s.table_name,25) "Object",	o.object_type 	"Type", 
		s.synonym_name	    "Dependent",	'SYNONYM'  		"Type"

	from	dba_synonyms@gisp		s,
		all_objects			o,
		plan_table			p
