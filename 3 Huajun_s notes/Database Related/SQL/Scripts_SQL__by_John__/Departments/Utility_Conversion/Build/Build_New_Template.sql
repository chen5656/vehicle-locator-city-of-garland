...
insert into JDEACUTIS.UTSANFIT
(                                                                                                                                                                        
	 mslink                                                                                                                                                                                                
	,mapid                                                                                                                                                                                                 
	,fitting_id                                                                                                                                                                                            
...
select 'UTSTOMDU' " "  from dual;
                                                                                                                                                                      
alter rollback segment rb1   online;
commit;
set transaction use rollback segment rb1;

	explain plan  set statement_id = 'UTSTOMDU' for 
                                                              
insert into JDEACUTIS.UTSTOMDU
(                                                                                                                                                                        
	 parcel_id                                                                                                                                                                                             
	,account                                                                                                                                                                                               
	,polyarea                                                                                                                                                                                              
...
insert into JDEACUTIS.UTSTOOCH
(                                                                                                                                                                        
	 mslink                                                                                                                                                                                                
	,mapid                                                                                                                                                                                                 
	,channel_type                                                                                                                                                                                          
...
select 'UTWATPLG' " "  from dual;
                                                                                                                                                                      
alter rollback segment rb1   online;
commit;
set transaction use rollback segment rb1;

	explain plan  set statement_id = 'UTWATPLG' for 
                                                              
insert into JDEACUTIS.UTWATPLG
(                                                                                                                                                                        
	 mslink                                                                                                                                                                                                
	,mapid                                                                                                                                                                                                 
	,ats                                                                                                                                                                                                   
