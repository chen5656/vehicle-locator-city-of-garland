   ...
   (
    ...
    ,UP_NODE_SUB_BASIN_ID          VARCHAR2 (5)
    ...
    ,DN_NODE_SUB_BASIN_ID          VARCHAR2 (5)
   ...
   (
    ...
    ,UPSTREAM_ELEV                 NUMBER   (22)
    ,DOWNSTREAM_ELEV               NUMBER   (22)
    ,UPSTREAM_HYD_GRADE            NUMBER   (22)
    ,DOWNSTREAM_HYD_GRADE          NUMBER   (22)
    ,GENERAL_COMMENTS              VARCHAR2 (40)
