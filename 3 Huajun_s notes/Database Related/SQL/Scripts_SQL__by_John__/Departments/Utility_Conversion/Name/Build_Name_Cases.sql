...
/*
	...
	( 'UTSANPLUG','UTSANFIT','PLUG','FITTING','0','SS','PL');	
	insert into garland.GIS_Objects  (item01, item02, item03, item04, item05, item06, item07)  values 
	( 'UTSANCLEN','UTSANFIT','CLEAN','FITTING','0','SS','CL');		
*/
-----------------------------------------------------------------------------------------------------------------------------------------------
--	05
    
	insert into garland.GIS_Objects  (item01, item02, item03, item04, item05, item06, item07)  values 
	( 'UTSANFITT','UTSANFIT','FITTING','PLUG','0','SS','JC');	
...
--	08
	...
	insert into garland.GIS_Objects  (item01, item02, item03, item04, item05, item06, item07)  values 
	( 'UTSTOJUNC','UTSTOJUN','JUNCTION','JUNC','0','ST','JC');			-- ****
