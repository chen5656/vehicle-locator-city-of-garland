...
--	===================================================================================
	water pipe objectid=8510 feature_id=181320 has 13 sections in the external view

	select count(*) missing_oid  from
	(
	select objectid || ' 0' from gis.water_pipe
	minus
	select text from jdeacutis.external_view1 where text like '% 0'
	);
*/
--	===================================================================================
...
while line_rec like '%QNAN'			loop
	...
	select feature_class, feature_id, utility_id 
	into	 this_feature_class, this_feature_id, this_utility_id  
	...
	if	do_insert > 0				then
		...
		(this_feature_class, this_utility_id, this_feature_id, xcoord1, ycoord1, xcoord2, ycoord2, null);  
