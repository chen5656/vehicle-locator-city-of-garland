...
--	================================================================
	...
	select count(*) Valve	from garland.view_Node_Master where node_type = 'V';
	select count(*) Dangle	from garland.view_Node_Master where node_type = 'D';
...
--	========================================================================================
	...
	(
	select feature_id from gis.water_pipe
	minus
...
--	========================================================================================
	...
	(
	select feature_id from gis.water_valve
	minus
