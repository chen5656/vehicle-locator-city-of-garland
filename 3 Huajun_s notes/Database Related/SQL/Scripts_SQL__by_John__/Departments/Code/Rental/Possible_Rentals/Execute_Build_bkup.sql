...
--	create synonym  garland.adrResult		for garland.ADRRESULT_EXTRACT;
	...
	@c:\deacutis\scripts\departments\code\rental\potential_vs_known\Rental_In_View.sql
	@c:\deacutis\scripts\departments\code\rental\potential_vs_known\Rental_View1.sql
	@c:\deacutis\scripts\departments\code\rental\potential_vs_known\Rental_View2.sql

	@c:\deacutis\scripts\departments\code\rental\potential_vs_known\Prep_Input.sql
...
--	===================================================================================================
	...
	@c:\deacutis\scripts\departments\code\rental\potential_vs_known\Merge_Extracts.sql
